	...
	public class P3dFollow_Editor : P3dEditor<P3dFollow>
	{
		protected override void OnInspector()
		{
			BeginError(Any(t => t.Target == null));
				DrawDefault("target", "This allows you to set the transform that will be followed.");
			EndError();
			DrawDefault("offset", "This allows you to set the world space offset of the target transform.");
			DrawDefault("tilt", "This allows you to set the euler offset of the target transform.");
			DrawDefault("dampening", "This allows you to set how quickly the transform follows.\n-1 = instant");
		}
	}
}
#endif
